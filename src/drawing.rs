...
pub fn draw_bbox_mut<'a, 'b, I, B, L>(image: &mut I,
                                      bbox: B,
                                      label_names: &L,
                                      font: &rusttype::Font)
          ...
          L: ?Sized + ops::Index<usize, Output = &'b str>
{
    ...
    for bb in bbox {
        ...
        let text_width = font.layout(&text,
            ...
            .max
            .x + 2;
        imageproc::drawing::draw_filled_rect_mut(image,
                                                 imageproc::rect::Rect::at(bb.left() as _,
                                                                           (bb.top() - scale) as
                                                                           _)
                                                         .of_size(text_width as _,
                                                                  scale as _),
                                                 image::Rgba { data: [255, 255, 255, 0] });
        ...
        draw_hollow_rect_mut(image,
                             ...
                             image::Rgba { data: [255, 0, 0, 0] },
                             5);
    }
}

fn draw_line_segment_mut<I>(image: &mut I,
                            start: (f32, f32),
                            end: (f32, f32),
                            color: I::Pixel,
                            thickness: f32)
          ...
          I::Pixel: 'static
{
    ...
    for point in line_iterator {
        imageproc::drawing::draw_filled_circle_mut(image,
...
fn draw_hollow_rect_mut<I>(image: &mut I,
